...
# Assuming you have multiple documents (sentences) for IDF calculation
...
# Displaying the selected top sentences for combined scores and write to the output file
